...
flutter run --observatory-port 9099 -d linux

flutter build linux
build/linux/release/bundle/app_superheroes


ldd build/linux/release/bundle/app_superheroes
...
https://flutter.dev/desktop#linux
...
flutter build windows
https://flutter.dev/desktop#windows
...
done: User Auth (OpenID Connect?)

TODO: Client muss Re-Login auslösen, wenn Token abgelaufen!!!

TODO: Auth Workaround für WebSocket...? Gibt es das schon fertig?
