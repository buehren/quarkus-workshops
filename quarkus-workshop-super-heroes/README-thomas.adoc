...
TODO: (Native) Build in Cloud. PC nicht blockiert + Relevant für Gitops

* So? https://quarkus.io/guides/building-native-image#using-a-multi-stage-docker-build
* Oder cloud build auch für native executable verwenden mit two-stage Dockerfile, das es irgendwo gibt
